...
v1.12.x 以降で `--classic-notenest` ルートの縮退・廃止を検討します。廃止の前提条件については [docs/design/nestsuite-default-startup-plan.md](../design/nestsuite-default-startup-plan.md) を参照してください。
