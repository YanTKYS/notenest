...
| TD-25 | SessionNest 第一段階整理 | `session.json` 読込 / 保存パスの整理・テスト追加。急がない。実施前に `docs/architecture/sessionnest-guardnest-policy.md` を参照すること | C |
| TD-26 | GuardNest 第一段階整理 | `AtomicFileWriter` / `CloseConfirmationService` の責務境界を明文化。急がない。実施前に `docs/architecture/sessionnest-guardnest-policy.md` を参照すること | C |
...
| TD-25 | SessionNest 第一段階整理 | v2.10.11 新規追加（C） |
| TD-26 | GuardNest 第一段階整理 | v2.10.11 新規追加（C） |
