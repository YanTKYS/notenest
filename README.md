...
- 通常起動（`NoteNest.exe`）は NestSuite が直接起動する
...
| `NoteNest.exe --classic-notenest` | **v1.19.3 で廃止。** NestSuite が通常起動する |
| `NoteNest.exe --classic-notenest sample.notenest` | **v1.19.3 で廃止。** NestSuite で対象ファイルが開く |
